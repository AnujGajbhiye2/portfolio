                            ...
                            <div class="mh-project-gallery col-sm-12 wow fadeInUp" id="project-gallery" data-wow-duration="0.8s" data-wow-delay="0.5s">
                                <div class="portfolioContainer row">
                                    <div class="grid-item col-md-4 col-sm-6 col-xs-12 user-interface">
                                        <figure>
                                            <img src="../assets/images/animetron.png" alt="img04">
                                            <figcaption class="fig-caption">
                                                <i class="fa fa-search"></i>
                                                <h5 class="title">Animetron</h5>
                                                <span class="sub-title">Ads Free Anime</span>
                                                <a data-fancybox data-src="#mh" href="http://animetron.netlify.com/" target="_blank"></a>
                                            </figcaption>
                                        </figure>
                                    </div>
                                    <div class="grid-item col-md-4 col-sm-6 col-xs-12 ui mockup">
                                        <figure>
                                            <img src="../assets/images/hopinstyle.png" alt="img04">
                                            <figcaption class="fig-caption">
                                                <i class="fa fa-search"></i>
                                                <h5 class="title">Hop In Style</h5>
                                                <span class="sub-title">Custom Shoes</span>
                                                <a href="https://www.hopinstyle.com/" data-fancybox data-src="#mh" target="_blank"></a>
                                            </figcaption>
                                        </figure>
                                    </div>
